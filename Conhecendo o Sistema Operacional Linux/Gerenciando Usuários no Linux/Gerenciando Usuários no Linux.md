...
### Verificando permissões de usuários que não pertence ao "ven" (Consegue acesso ao diretório, ler o arquivo-maisa, e não consegue remover o arquivo-maisa.txt).
